 ...
 * 
 * PRD Compliance:
 * - Uses `/api/v1/profiler/address/current-balance` for holdings
 * - Uses `/api/v1/token-screener` for liquidity check
 * - Filters: holdings > $5, liquidity < $10k
 * - Analyzes 1-year data
